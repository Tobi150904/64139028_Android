...
public class CppActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questions.add(new Question("What is C++?", new String[]{"A programming language", "A car", "A fruit", "A city"}, "A programming language"));
        questions.add(new Question("Who developed C++?", new String[]{"Bjarne Stroustrup", "James Gosling", "Dennis Ritchie", "Guido van Rossum"}, "Bjarne Stroustrup"));
        questions.add(new Question("What is the extension of C++ files?", new String[]{".java", ".py", ".cpp", ".cs"}, ".cpp"));
